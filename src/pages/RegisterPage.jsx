                      ...
                      <div className="flex gap-2">
                        ...
                        {!isOtpSent && (
                          <button
                            type="submit"
                            disabled={isLoading}
                            className="whitespace-nowrap border-2 border-red-700d bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50"
                          >
